        ...
        <div>
            <Grid className={classes.resumeGrid}>
                <Cell col={4}>
                    ...
                    <p>Having a total of 1.5 years of experience in IT as a quality analyst.Advanced knowlede of Html/css,Javascript,React js,Redux.Intrested to work on a challenging job profile which provides an opportunity to enhance my technical skills and knowledge </p>
                    <hr style={{ borderTop: '3px solid #833fb2', width: "60%" }} />
                    <h5>Address</h5>
                    <p>(2,99) (7,1) Nidhi kenja road Katipalla kaikamba,Mangalore-575030</p>
                    <h5>Phone Number </h5>
                    <p>9449085956</p>
                    ...
                    <h5>Date Of Birth</h5>
                    <p> 7'th  April 1996</p>
                    <hr style={{ borderTop: '3px solid #833fb2', width: "60%", marginBottom: "30px" }} />
                    <a className={classes.download} href={Doc} rel="noopener noreferrer" download >Download Resume</a>
                </Cell>
