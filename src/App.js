  ...
  return (
    <div className="demo-big-content">
      <Layout>
        ...
        >
          <Navigation>
            <NavLink to="/AboutMe" activeClassName={classes.active}>
              AboutMe
            </NavLink>
        ...
        >
          <Navigation>
            <NavLink to="/AboutMe" onClick={hideModal}>
              AboutMe
            </NavLink>
            <NavLink to="/Resume" onClick={hideModal}>
              Resume
            </NavLink>
            <NavLink to="/Projects" onClick={hideModal}>
              Projects
            </NavLink>
            <NavLink to="/Contact" onClick={hideModal}>
              Contact
            </NavLink>
          </Navigation>
        </Drawer>
